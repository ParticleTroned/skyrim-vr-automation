...
$tests = @(
    ...
    @{ Name = 'mo2-steamvr-exclusions'; Path = 'tools\mo2-control\tests\Test-MO2SteamVRExclusions.ps1'; Arguments = @() },
    @{ Name = 'mo2-shutdown-reporting'; Path = 'tools\mo2-control\tests\Test-MO2ShutdownReporting.ps1'; Arguments = @() },
