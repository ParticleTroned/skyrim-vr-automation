...
try {
    ...
    foreach ($skill in @('feedback-control', 'mo2-control', 'steamvr-null-hmd', 'devbench-control', 'coc-stability', 'simple-coc', 'simple-coc-5', 'simple-csm', 'renderscale-tuning', 'static-coc', 'profiler-control', 'shader-cache-control')) {
