...
try {
    ...
    foreach ($skill in @('feedback-control', 'mo2-control', 'steamvr-null-hmd', 'devbench-control', 'coc-stability', 'simple-coc', 'simple-coc-5', 'static-coc', 'profiler-control', 'shader-cache-control')) {
